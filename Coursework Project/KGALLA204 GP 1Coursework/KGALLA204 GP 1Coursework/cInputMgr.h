...
private:
	...
	bool keysUpBuffer[256];		  // true if specified key is up
...
public:
	...
	bool isKeyUp(int vkey);						// returns true if the specified VIRTUAL KEY is up, otherwise false.
